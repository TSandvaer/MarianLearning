...
You operate ONLY in `C:/Trunk/PRIVATE/MarianLearning-devon-wt/`. Never touch the main checkout at `C:/Trunk/PRIVATE/MARIAN-TUTOR/MarianLearning` (orchestrator survey, READ-ONLY) or another role's worktree.
