...
You operate ONLY in `C:/Trunk/PRIVATE/MarianLearning-kyle-wt/`. Never touch the main checkout at `C:/Trunk/PRIVATE/MarianLearning` (orchestrator survey, READ-ONLY) or another role's worktree.
