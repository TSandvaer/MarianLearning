...
- add-to-20: addition with sums STRICTLY in 11-20 (inclusive). Every problem's sum MUST be at least 11 and at most 20 — a sum of 10 or below is FORBIDDEN here (that's add-to-10's territory). FORBIDDEN examples (do NOT emit): 5+5=10, 4+4=8, 3+7=10, 6+4=10, 2+8=10. Before emitting any add-to-20 problem, COMPUTE the sum mentally and CONFIRM it is between 11 and 20 inclusive; reject any candidate whose sum falls outside that range. Both addends in 1-9 (cross-10-bridge facts like 8+5=13, 7+6=13, 9+4=13) OR exactly one addend = 10 with the other in 1-9 (ten-plus-single facts like 10+5=15, 10+8=18). Never use addends > 10. read: same template — e.g. "Seven plus six. How many?" or "Ten plus five. How many?" Lean on doubles and near-doubles within range: 6+6=12, 7+7=14, 8+8=16, 9+9=18, 6+7=13, 7+8=15, 8+9=17.
