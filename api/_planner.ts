...
- sub-to-20: subtraction with minuend in [11, 19] and subtrahend in [1, 9] and result in [10, 18]. <drift-guard RULE_IDENTITY=sub-to-20; SPEC=design/math/sub-to-20-content.md§1.1; LINT=scripts/compositionLint.ts:1198 (RULES) + 1312 (lint fn) + 4917-4921 (resolveTierBinding BINDING)> Do NOT rename, re-band, re-cap, or substitute facts under any seed.</drift-guard> NO BORROW — the ones-digit of the minuend MUST be >= subtrahend. read: "<minuend> minus <subtrahend>. How many are left?" e.g. "Seventeen minus five. How many are left?"
