...
// Storage keys, the `StateExportPayload` type, and `buildStateExportPayload`
// were extracted to `./stateExport.ts` so this file only exports React
// components — keeps `react-refresh/only-export-components` happy. Tests
// import the function directly from `./stateExport`. Re-exporting the type
// here keeps any external `import type { StateExportPayload } from './DebugOverlay'`
// working without trip-hazard.
export type { StateExportPayload } from './stateExport'
